...
class ObjectDetectionBot(Bot):
    ...
    # TODO send a request to the `amin_yolo5` service for prediction - Done!
    ...
    def handle_message(self, msg):
        ...
        if not (self.is_current_msg_photo(msg)):
            completion = self.chat_gpt_client.chat.completions.create(
                ...
                messages=[
                    {"role": "system",
                     "content": "You are a precise, swift, funny, friendly, and to the point assistant. You use "
                                "emogies. Your name is AminBot."},
            ...
            try:
                self.send_text(msg['chat']['id'], "Photo received! 🌟 I'm swiftly scanning it... "
                ...
                if len(yolo_results) == 1:
                    if yolo_results[0] == {'class': "", 'cx': 0, 'cy': 0, 'width': 0, 'height': 0}:
                        self.send_text(msg['chat']['id'], "Oops, your image has left me scratching "
                                                          "my circuits! I must've missed a few updates. 😅 "
                                                          "Could you send a different image, "
                                                          "so I can try again?")
                        return
                ...
                self.send_text(msg['chat']['id'], f"I've scanned your image and here's what I found:\n{summary}")
                ...
                self.send_text(msg['chat']['id'], "One more thing! 🌟 A small gift 🎁 is on its way to you. Just a "
                                                  "little more patience. It's worth the wait! 😊")
                prompt = summary
    ...
    def request_yolo_prediction(s3_url):
        ...
        yolo_endpoint = 'http://amin_yolo5:8081/predict'
